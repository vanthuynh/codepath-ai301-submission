...
- I'm most comfortable programming with Python and JavaScript. I have front-end experience with React and backend experience with Flask, NodeJS, ExpressJS.
- I want to get better at reading unfamiliar codebase, reproducing bugs, and working through a real maintainer-review process. I prefer bounded bug fixes or docs task and would like to avoid issues that require deep domain knowledge
